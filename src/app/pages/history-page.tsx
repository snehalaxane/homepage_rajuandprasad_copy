    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[#022683] font-semibold">Loading history...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 text-sm text-[#888888] mb-6">
              ...
              <span className="text-[#022683] font-medium">History</span>
            </div>

            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              <span className="text-[#022683]">History</span>
            </h1>
            ...
            >
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-8 shadow-lg border border-gray-100">
                <div className="relative">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-[#022683] to-blue-400 rounded-full" />
                  <div className="pl-6 space-y-4">
                    {journey?.description ? (
                      journey.description.split('\n').map((para, index) => (
                        para.trim() && (
                          <p key={index} className="text-lg text-[#888888] leading-relaxed">
                            {para}
                          </p>
                        )
                      ))
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                ...
                >
                  <p className="text-4xl font-bold text-[#022683] mb-2">{journey?.yearsOfService || '46+'}</p>
                  <p className="text-sm text-[#888888] font-medium">Years of Service</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow"
                >
                  <p className="text-4xl font-bold text-[#022683] mb-2">{journey?.activeLocations || '7'}</p>
                  <p className="text-sm text-[#888888] font-medium">Active Locations</p>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              <div className="mb-8">
                <h3 className="text-3xl font-bold text-gray-900 mb-2">
                  Branch <span className="text-[#022683]">Timeline</span>
                </h3>
                <p className="text-[#888888]">Our expansion journey across India</p>
              </div>

              {/* Timeline */}
              <div className="relative">
                {/* Connecting Line */}
                <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#022683] via-blue-300 to-gray-200" />
                ...
                <div className="space-y-6">
                  {timeline.length > 0 ? (
                    timeline.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          {/* Timeline Dot */}
                          <div
                            className={`absolute left-0 top-4 w-16 h-16 rounded-full flex items-center justify-center transition-all duration-300 ${status === 'established'
                              ? 'bg-gradient-to-br from-[#022683] to-blue-500 shadow-lg shadow-[#022683]/30 scale-110'
                              : status === 'active'
                                ? 'bg-gradient-to-br from-[#022683] to-blue-400 shadow-lg shadow-[#022683]/20'
                          ...
                          {/* Content Card */}
                          <div
                            className={`bg-white rounded-2xl p-6 shadow-lg border transition-all duration-300 ${status === 'active' || status === 'established'
                              ? 'border-[#022683]/20 hover:border-[#022683] hover:shadow-xl hover:-translate-y-1'
                              : 'border-gray-200 hover:shadow-xl hover:-translate-y-1'
                              }`}
                          >
                            <div className="flex items-start justify-between mb-3">
                              <h4 className="text-xl font-bold text-gray-900 group-hover:text-[#022683] transition-colors">
                                {item.title}
                              </h4>
                              <span
                                className={`px-3 py-1 rounded-full text-xs font-semibold ${status === 'established'
                            ...
                            <p className="text-[#888888] text-sm mb-2">{item.subtitle}</p>
                            <div className="flex items-center gap-2 text-[#022683] font-semibold">
                    ...
                    <div className="pl-20 py-10 text-[#888888]">No timeline events found.</div>
                  )}
                </div>
              </div>
            </motion.div>
      ...
      {mission?.enabled !== false && (
        <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50/20">
          <div className="container mx-auto px-6">
            ...
            >
              <div className="relative bg-gradient-to-br from-[#022683] to-blue-600 rounded-3xl p-12 lg:p-16 shadow-2xl shadow-[#022683]/20 overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Want to work with a <span className="text-[#022683]">trusted CA firm?</span>
            </h2>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#022683] text-white rounded-full hover:bg-[#011952] transition-all shadow-lg shadow-[#022683]/30 hover:shadow-xl font-semibold"
              >
                Contact Us
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-2 px-8 py-4 bg-white border-2 border-[#022683] text-[#022683] rounded-full hover:bg-[#022683] hover:text-white transition-all shadow-lg font-semibold"
              >
                Explore Services
              </motion.a>
            </div>
